...
const Moviecard = ({movie}) => {
  ...
  return (
    <div className='bg-gray-800 p-4 rounded-lg shadow-md text-white relative'>
      <img src={`https://media.themoviedb.org/t/p/w440_and_h660_face/${movie.poster_path}`} alt={movie.title} className='w-full h-80 object-contain rounded-sm'/>
      <h3 className='tetx-lg font-bold mt-4'>{movie.title}</h3>
